...
- [ ] Confirm Excel column mapping matches expectations
...
- Use `data_only=True` to read calculated values — **warning**: saving with this flag permanently destroys formulas
