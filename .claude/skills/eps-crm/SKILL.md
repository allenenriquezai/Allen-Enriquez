---
name: eps-crm
description: Use when looking up, updating, or managing Pipedrive deals, contacts, stages, or notes for EPS. Triggered by phrases like "look up deal", "find client in Pipedrive", "update deal", "post a note", "what stage is", "move deal to", "check Pipedrive".
...
`projects/eps/workflows/crm-ops.md`
